...
go
	...
	EXEC InsertDataEmployee N'Shruti', N'Bhati', '1996/4/13' , N'F', 2 , 'shruti.bhati', '2014/11/03', 2

go

	EXEC InsertLeaves N'Casual', 3;
...
go
	EXEC InsertLeaveRequest 6, 'Casual', '2019/10/23', '2019/10/25', N'Family Function'
